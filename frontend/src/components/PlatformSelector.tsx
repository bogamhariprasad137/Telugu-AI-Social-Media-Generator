  ...
  return (
    <div className="space-y-3.5">
      <div className="flex items-center justify-between">
        <span className="font-telugu text-sm lg:text-base font-bold text-slate-800 dark:text-slate-200 flex items-center gap-1.5">
          సోషల్ మీడియా ఫ్లాట్‌ఫాం <span className="text-xs font-normal text-slate-400 dark:text-slate-500">(Target Platform)</span>
        </span>
      </div>
